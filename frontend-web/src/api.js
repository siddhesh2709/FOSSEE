...
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://chemical-backend-1xii.onrender.com/api';
...
const api = {
  // Health checks
  healthCheck: () => {
    return axios.get('https://chemical-backend-1xii.onrender.com/health/');
  },
  
  dbCheck: () => {
    return axios.get('https://chemical-backend-1xii.onrender.com/db-check/');
  },
